...
@keyframes coockieBoxAnimation {
  ...
  html {
    ...
    mark {
      background-color: ${({ theme }) => theme.colors.markBg};
    ...
    *:after {
    ...
    pre {
      ...
      font-size: 0.85rem;
      line-height: 1.42;
      background: ${({ theme }) => theme.colors.hslaWhiteBg};
      border-radius: 3px;
      overflow: auto;
      word-wrap: normal;
      padding: 1.45rem;
    ...
    tt,
    code {
      background-color: ${({ theme }) => theme.colors.hslaWhiteBg};
      border-radius: 3px;
...
/*       ::-webkit-scrollbar {
    ...
    h1 {
      font-size: clamp(1.5rem, 3.0vmax, 4rem);
    }
    h2 {
      font-size: clamp(1.3rem, 2.5vmax, 3rem);
    }
    h3 {
      font-size: clamp(1rem,1.8vmax,2.2rem);
    }
    h4 {
      font-size: clamp(1.8rem, 2vmax, 2rem);
    }
    h5 {
      font-size: clamp(1.125rem, 2.4vmax, 2rem);
      line-height: 3rem;
    }
    p {
    ...
    li {
      font-size: clamp(0.75rem,1.3vmax, 2rem);
      line-height: 3rem;
    }
