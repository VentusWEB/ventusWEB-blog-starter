...
export const ScrollBtn = ({
    ...
    return (
        <div>
            {show &&
                <ScrollButton title={buttonScrollName ? buttonScrollName : "scroll top!"} buttonScrollColor={buttonScrollColor} buttonScrollColorHover={buttonScrollColorHover} onClick={handleClick} aria-label="to top">
